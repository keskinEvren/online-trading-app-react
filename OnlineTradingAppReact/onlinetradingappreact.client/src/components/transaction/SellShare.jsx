...
import { sellShare } from '../../services/transactionService';
...
const SellShare = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await sellShare(transaction);
            navigate('/transaction');
        } catch (error) {
            console.log('selam', error)
            setError(error.response.data.message || 'Error processing sell transaction');
        }
    };
